...
namespace LightningRyze
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("Exploit").AddItem(new MenuItem("exploitDelay", "Exploit Delay").SetValue(new Slider(25, 150,0)));
        ...
        {
            var UsePacket = Config.Item("UsePacket").GetValue<bool>();
            var delayExploit = Config.Item("exploitDelay").GetValue<Slider>().Value;
